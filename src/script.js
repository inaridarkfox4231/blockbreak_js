...
// 2021/09/08
// TODOいくつか
// まず音のところ、idで整理していくつもメソッド要らないでしょ
// StateはSceneに改名すべき。その方が一般的。
// Sceneにしたとして、コンストラクタで名前を渡さない理由が不明瞭・・名前渡せばいいじゃん。渡そうよ。
// アークパドル廃止
// 追加で100個ステージ作れないなら20個でもいいと思う。
// クラス名のGameSystemはGameでもいい気がする。
// 複数パドルでシフトキー使ってボールの位置を変更する計画がある・・？
// ボタンUIはクラスにした方がいいかも
// SystemになってるところをGameにしてPlaySceneの方のGameSystemをSystemにすればいいんじゃないかと。
// つまりScene全体を統括するクラスがGameでPlayの中身全体を統括するのがSystemという構成。
// GameにはいくつかのSceneが格納されていてそれをとっかえひっかえすることで画面を表示する。
// それでいこう
